          ...
          className={
            layout === 'stacked'
              ...
              : layout === 'overlap'
                ...
                : 'relative z-10 lg:col-span-7 lg:pr-12'
          }
        >
          <motion.div
          ...
          <h1 className="font-display max-w-[12ch] text-5xl leading-[0.95] font-extrabold tracking-tight text-[color:var(--bd-bone)] italic sm:text-6xl md:text-7xl lg:text-[7rem]">
