...
export default function ClosingCTA() {
  ...
  return (
    <section className="relative isolate flex min-h-[60vh] items-center overflow-hidden pt-16 md:min-h-[68vh] md:pt-20">
      <div
        aria-hidden
      ...
      <div className="relative mx-auto grid w-full max-w-7xl items-center gap-10 px-6 pb-0 lg:grid-cols-12">
        ...
        <div className="relative z-10 lg:col-span-6">
          ...
          <Reveal delay={0.05} pace="late">
            <h2 className="font-display mt-4 text-4xl leading-[0.95] font-bold tracking-tight italic sm:text-5xl md:text-6xl lg:text-[7rem]">
              Build the
              <br />
