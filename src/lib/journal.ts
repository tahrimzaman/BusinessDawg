...
export const JOURNAL: JournalPost[] = [
  ...
  },
  {
    ...
    excerpt:
      'Productized agency engagements ship predictable scope. Custom engagements ship depth. Most teams pick the wrong model and pay for it twice. Here is the operator-level distinction.',
    publishedAt: '2026-05-15',
    readingTime: 6,
    kicker: 'Field notes / Engagement models',
    lede: 'Productized agency engagements ship predictable scope. Custom engagements ship depth. Both are valid. Most teams pick the wrong model and pay for it twice, in cash and in calendar.',
    sections: [
      {
        heading: 'The one-line version',
        paragraphs: [
          'Productized means the scope and the deliverable are defined before you sign. You are buying a known shape. Custom means the scope is defined after a discovery period, by the team you hired to define it. You are buying a process, not a deliverable.',
      ...
      },
      {
        ...
        paragraphs: [
          'A productized engagement has a fixed scope and a fixed deliverable. The agency has run this exact shape many times before, so they can quote it, ship it, and hand it off without renegotiating mid-engagement. The work is real. The scope discipline is the product.',
        ],
        list: [
          'Scope is written in concrete deliverables, not abstract goals',
          'The shape is defined upfront and the team works backward from it',
          'Price is named upfront, even if it is custom-quoted per engagement',
          'The agency owns scope creep, so extra work either gets cut or quoted as a separate engagement',
      ...
      },
      {
        ...
        paragraphs: [
          'A custom engagement starts with a discovery phase. Discovery is real work, but it is also the agency figuring out what to build, on your dime. The scope and price emerge from discovery, not before it. The depth is the product.',
        ],
        list: [
          'Discovery phase is paid (sometimes called "audit", "strategy sprint", "intake")',
          'Scope is written after discovery, in a phase 2 SOW',
          'Scope expands as discovery surfaces complexity',
          'Price is "estimate to actual", so the final cost is known at the end',
      ...
      },
      {
        ...
        list: [
          ...
          'You have a real outcome you need to hit, with specifics, not vibes.',
      ...
      },
      {
        ...
        paragraphs: [
          'Even when the work is eventually going to be custom, starting with a productized engagement is almost always the right move. A productized audit will tell you whether the bigger custom engagement is worth scoping. It is a small bet that produces a clear decision. It costs less than the discovery phase of a custom engagement would have cost, and it leaves you with a deliverable either way.',
  ...
  },
  {
    ...
    lede: 'Brand studios make you look real. Growth studios make you move money. Most teams need both, in the right order, with the right shape underneath. Picking wrong burns the budget that came with it. Here is the operator-level distinction.',
    sections: [
      {
        heading: 'The one-line version',
        paragraphs: [
      ...
      },
      {
        ...
        list: [
          ...
          'Component library or design system (so the brand survives execution at scale)',
      ...
      },
      {
        ...
        list: [
          ...
          'Operating cadence (rhythm, dashboards, decision points)',
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: 'The four-question decision frame',
        paragraphs: [
  ...
  },
  {
    ...
    lede: 'Most "growth projects" leak before anyone writes a line of code. Not because the team is bad, but because the scope was wrong the day it was signed. Here is how an operator scopes one that actually ships.',
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          'Before any agency, freelancer, or in-house hire writes a brief, the founder has to answer three questions out loud. Skipping any of them is why the engagement turns into a Notion graveyard.',
        ],
        list: [
          'What is the one number that has to move, and what is it today? Not "MRR up". A specific number with a specific delta. "Demo bookings from 12 a month to 40."',
      ...
      },
      {
        ...
        list: [
          'Outcome: the specific number we are accountable for, with a clear delta. One line.',
          ...
          'Operating cadence: how the team meets, what they review, what they ship. If the project does not produce a recurring rhythm, it produced a deck.',
      ...
      },
      {
        ...
        paragraphs: [
          'Three patterns show up in bad growth scopes, every single time. Spotting them is cheaper than discovering them late.',
        ],
        list: [
          ...
          'No success metric, or a vanity one ("we will improve brand awareness"). That is not scoping, it is wishing. If the scope cannot fail, the scope cannot succeed.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          'We open every engagement with a 30-minute call. No deck. We name the outcome, the bottleneck thesis, and the cadence on that call, or we tell you the engagement is not ready yet. We charge the same way: outcome, scope, ship.',
