        ...
        */}
        ...
        <section className="mt-20">
          ...
          <Reveal delay={0.05}>
            <div className="mt-5 space-y-5 text-lg leading-relaxed text-[color:var(--bd-bone)]/80">
              <p>
                A simple landing page and a full web product with AI workflows do not belong on the
                same price sheet. Listing &ldquo;starting at $X&rdquo; would either over-quote the
                small engagement or under-quote the big one. Both options cost the operator-founder
                real money.
              </p>
              <p>
          ...
          <Reveal delay={0.05}>
            <div className="mt-5 space-y-5 text-lg leading-relaxed text-[color:var(--bd-bone)]/80">
              <p>
                ...
                need and the bottleneck you think the engagement is pointing at. By the end of that
                call we either tell you which system from the Systems Stack fits, propose a custom
                scope built on one or two systems as the anchor, or tell you honestly that we are
                not the right studio for what you need.
              </p>
              <p>
                After the call, we send a written scope: outcome, deliverables, price, and what
                hand-off looks like. If you sign, we kick off. If you do not, the call cost nothing.
              </p>
            </div>
          </Reveal>
        </section>
          ...
          <Reveal delay={0.1}>
            <ul className="mt-6 space-y-3 text-lg leading-relaxed text-[color:var(--bd-bone)]/80">
              {[
                ...
                'Scope compression: tighter engagements compress what bigger ones absorb. Compression has a price; so does patience. We quote both.',
        ...
        <section className="mt-20">
          ...
          <Reveal delay={0.05}>
            <ul className="mt-6 space-y-3 text-lg leading-relaxed text-[color:var(--bd-bone)]/80">
              {[
                'The outcome the engagement is scoped to move: the specific number we are accountable for.',
                'The deliverables, named explicitly and ordered by priority.',
                'The price: fixed for the scope, not estimate-to-actual.',
                'The hand-off: what artifacts you own, what training is included, and what handover looks like.',
          ...
          <Reveal delay={0.05}>
            <div className="mt-5 space-y-5 text-lg leading-relaxed text-[color:var(--bd-bone)]/80">
              <p>
                ...
                outcome, deliverables, hand-off. Productized engagements are quoted at the call.
              </p>
              <p>
        ...
        <Reveal>
          <div className="mt-20 rounded-3xl border border-[color:var(--bd-lime)]/30 bg-[color:var(--bd-lime)]/5 p-8 md:p-10">
            ...
            <p className="mt-3 max-w-xl text-[color:var(--bd-bone)]/70">
              30 minutes. No decks. You leave the call with a clear sense of scope and whether the
              engagement is worth booking. The call itself is free.
            </p>
            <div className="mt-6">
              <MagneticButton href="/contact">Book the call →</MagneticButton>
            </div>
